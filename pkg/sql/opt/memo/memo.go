...
func (m *Memo) Init(ctx context.Context, evalCtx *eval.Context) {
	...
	*m = Memo{
		...
		showInsertFastPathChecks:                   evalCtx.SessionData().ShowInsertFastPathChecks,
...
func (m *Memo) IsStale(
	...
	if m.reorderJoinsLimit != int(evalCtx.SessionData().ReorderJoinsLimit) ||
		...
		m.showInsertFastPathChecks != evalCtx.SessionData().ShowInsertFastPathChecks ||
