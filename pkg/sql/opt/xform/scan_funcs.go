...
func (c *CustomFuncs) GenerateLocalityOptimizedSearch(
	...
	var duplicateLookupSide func() *memo.ScanPrivate
	...
	inputScanPrivateWithCRDB_RegionCol :=
		&memo.ScanPrivate{
	...
	// remapping.
	inputScanPrivateWithCRDB_RegionCol.Cols.Add(firstIndexCol)
	...
	if duplicateLookupTableFirst {
		...
		localInputSP = c.DuplicateScanPrivate(inputScanPrivateWithCRDB_RegionCol)
		remoteInputSP = c.DuplicateScanPrivate(inputScanPrivateWithCRDB_RegionCol)
	} else {
		localInputSP = c.DuplicateScanPrivate(inputScanPrivateWithCRDB_RegionCol)
		remoteInputSP = c.DuplicateScanPrivate(inputScanPrivateWithCRDB_RegionCol)
		newLocalLookupTableSP = duplicateLookupSide()
	...
	localSelectFilters =
		c.RemapScanColsInFilter(localSelectFilters, inputScanPrivateWithCRDB_RegionCol, &localScan.ScanPrivate)
	remoteSelectFilters =
		c.RemapScanColsInFilter(remoteSelectFilters, inputScanPrivateWithCRDB_RegionCol, &remoteScan.ScanPrivate)
	...
	leftColMap := c.makeColMap(inputScanPrivateWithCRDB_RegionCol, &localScan.ScanPrivate)
	rightColMap := c.makeColMap(inputScanPrivateWithCRDB_RegionCol, &remoteScan.ScanPrivate)
